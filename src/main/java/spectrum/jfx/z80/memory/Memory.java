...
public class Memory {
    ...
    public Memory() {
        ...
        logger.info("Memory initialized: ROM={}K, RAM={}K", ROM_SIZE / 1024, RAM_SIZE / 1024);
    }
    ...
    public boolean isRomWriteProtected() {
        return romWriteProtected;
    }
