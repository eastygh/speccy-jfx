...
public class TapFilePlayback implements TapeSignal {
    ...
    private static final int PILOT_PULSE_LENGTH = 2168;  // Длина пилот-импульса
    private static final int PILOT_PULSE_DATA_COUNT = 3223;    // Количество пилот-импульсов данных
    private static final int PILOT_PULSE_HEADER_COUNT = 8063;    // Количество пилот-импульсов заголовка
    private static final int SYNC1_PULSE_LENGTH = 667;   // Первый синхро-импульс
    private static final int SYNC2_PULSE_LENGTH = 735;   // Второй синхро-импульс
    private static final int ZERO_PULSE_LENGTH = 855;    // Импульс для бита 0
    private static final int ONE_PULSE_LENGTH = 1710;    // Импульс для бита 1
    private static final int FINAL_SYNC = 945; // финальный синхро-импульс
    private static final int PAUSE_PULSE_LENGTH = 3500000;    // Пауза между секциями
