...
public class TRDOSController implements AddressHookController {
     ...
     * Enable TR-DOS rom
     */
    private synchronized void switchToTRDOS() {
     ...
     * Disable TR-DOS rom
     */
    private synchronized void switchToZXSpectrum() {
