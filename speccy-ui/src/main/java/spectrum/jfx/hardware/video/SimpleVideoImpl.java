 ...
 */
public class SimpleVideoImpl {

}
//public class SimpleVideoImpl implements spectrum.hardware.video.Video<Canvas>, OutPortListener {
//
...
//    @Getter
//    private spectrum.hardware.video.ZoomLevel currentZoom = spectrum.hardware.video.ZoomLevel.X2; // По умолчанию x2 для удобства
...
//        this(memory, spectrum.hardware.video.ZoomLevel.X2); // По умолчанию x2 масштаб для удобства
//    }
//
//    public SimpleVideoImpl(Memory memory, spectrum.hardware.video.ZoomLevel initialZoom) {
//        this.memory = memory;
...
//        }
//
//        spectrum.hardware.video.ZoomLevel oldZoom = currentZoom;
//        currentZoom = newZoom;
//
...
//        spectrum.hardware.video.ZoomLevel[] levels = spectrum.hardware.video.ZoomLevel.values();
